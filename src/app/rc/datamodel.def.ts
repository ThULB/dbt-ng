...
export const dateStringMatch = (str: string) => {
...
export const toDate = (day: string | number, month: string | number, year: string | number, endOfDay: boolean = false): Date => {
...
export const matchingPeriod = (validTo: string): Period => {
