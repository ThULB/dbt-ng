...
import { AdminRoles, EditorRoles, Slots } from "./datamodel.def";
...
export const resolveFnSlots = ($api: RCApiService, $auth: AuthService, $error: ErrorService, $spinner: SpinnerService, trans: Transition) => {
