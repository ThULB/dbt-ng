...
export const resolveFnObject = ($api: ApiService, $error: ErrorService, $spinner: SpinnerService, trans: Transition) => {
...
export const resolveFnDerivates = ($api: ApiService, $error: ErrorService, $spinner: SpinnerService, trans: Transition) => {
